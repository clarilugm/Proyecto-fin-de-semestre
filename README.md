...
- **Noelia Castro** - Artículo sobre Música: *"El impacto del K-pop alrededor del mundo"*
- **Ornella Balduvino** - Artículo sobre Turismo: *"Francia: el país más visitado del mundo"*
...
- **Artículos detallados**: Contenido bien estructurado con imágenes, títulos y descripciones
- **Sistema de comentarios**: Permite a los lectores interactuar con el contenido
...
- **Bootstrap 5.3.3**: Framework para componentes y grid system
...
│   └── Post-musica/        # Imágenes del artículo de música
└── pages/                  # Páginas individuales de cada artículo
    ├── post-musica.html    # Artículo sobre K-pop (Noelia)
    ├── post-turismo.html   # Artículo sobre Francia (Ornella)
    ├── post-comida.html    # Artículo sobre cocina italiana (Clara)
...
**Temas cubiertos:**
- Historia y origen del K-pop
- El rol transformador de BTS
...
**Contenido incluido:**
- Razones del éxito turístico francés
- Consejos culturales (idioma, horarios, etiqueta)
...
- **Colores primarios**: Tonos tierra (#3d1f0d, #6b3320)
- **Acentos**: Beige y crema (#f2e6d5, #dfc09a, #c8956a)
- **Fondo**: Crema suave (#faf4ec)
